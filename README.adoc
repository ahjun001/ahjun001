...
For each technology, maintain a cheatsheet, personal or outsourced, that points what responses to typical situations should be, backed with sources, illustrated with examples.
